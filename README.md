...
* [Technical documentation](https://github.com/grpc/grpc/tree/master/doc) ⭐ 45,325 | 🐛 1,347 | 🌐 C++ | 📅 2026-09-18 - Collection of useful technical documentation
* [gRPC status codes](https://github.com/grpc/grpc/blob/master/doc/statuscodes.md) ⭐ 45,325 | 🐛 1,347 | 🌐 C++ | 📅 2026-09-18 - Status codes and their use in gRPC
* [gRPC status code mapping](https://github.com/grpc/grpc/blob/master/doc/http-grpc-status-mapping.md) ⭐ 45,325 | 🐛 1,347 | 🌐 C++ | 📅 2026-09-18 - HTTP to gRPC Status Code Mapping
...
* [gRPC Core](https://github.com/grpc/grpc) ⭐ 45,325 | 🐛 1,347 | 🌐 C++ | 📅 2026-09-18 - C, C++, Ruby, Node.js, Python, PHP, C#, Objective-C
* [grpc\_cli](https://github.com/grpc/grpc/blob/master/doc/command_line_tool.md) ⭐ 45,325 | 🐛 1,347 | 🌐 C++ | 📅 2026-09-18 - gRPC CLI tool
* [gRPC Go](https://github.com/grpc/grpc-go) ⭐ 23,069 | 🐛 139 | 🌐 Go | 📅 2026-09-17 - The Go language implementation of gRPC. HTTP/2 based RPC
* [gRPC Java](https://github.com/grpc/grpc-java) ⭐ 12,072 | 🐛 532 | 🌐 Java | 📅 2026-09-17 - The Java gRPC implementation. HTTP/2 based RPC
* [gRPC Web](https://github.com/grpc/grpc-web) ⭐ 9,261 | 🐛 169 | 🌐 JavaScript | 📅 2026-09-04 - gRPC for Web Clients
...
* [gRPC Dart](https://github.com/grpc/grpc-dart) ⭐ 892 | 🐛 112 | 🌐 Dart | 📅 2026-09-17 - The Dart language implementation of gRPC
...
* [grpcui](https://github.com/fullstorydev/grpcui) ⭐ 5,929 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-14 - An interactive web UI for gRPC, along the lines of postman (also, a Go library for embedding these web UIs into Go HTTP servers)
...
* [Microcks](https://github.com/microcks/microcks) ⭐ 2,044 | 🐛 55 | 🌐 Java | 📅 2026-09-17 - A [Cloud Native Computing Sandbox project](https://landscape.cncf.io/?selected=microcks) 🚀 dedicated to API Mocking and Testing ([gRPC supported](https://microcks.io/documentation/using/grpc/))
...
* [APISIX](https://github.com/apache/apisix) ⭐ 17,139 | 🐛 242 | 🌐 Lua | 📅 2026-09-18 - An api gateway that supports gRPC, HTTP(s) to gRPC and gRPC web request proxying.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,724 | 🐛 271 | 🌐 Java | 📅 2026-09-18 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [grpcui](https://github.com/fullstorydev/grpcui) ⭐ 5,929 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-14 - Embed a gRPC web UI into a Go gRPC/HTTP server
...
* [yarpc](https://github.com/yarpc/yarpc-go) ⭐ 442 | 🐛 60 | 🌐 Go | 📅 2026-09-17 - A message passing platform for Go, including support for gRPC
...
* [gapic-generator-ruby](https://github.com/googleapis/gapic-generator-ruby) ⭐ 50 | 🐛 39 | 🌐 Ruby | 📅 2026-09-17 - Generates Ruby gRPC client libraries from protocol buffer definitions of an API.
...
* [tonic](https://github.com/hyperium/tonic) ⭐ 12,477 | 🐛 363 | 🌐 Rust | 📅 2026-09-18 - A native gRPC client & server implementation with async/await support
...
* [Third-Party Add-ons for Protocol Buffers](https://github.com/protocolbuffers/protobuf/blob/master/docs/third_party.md) ⭐ 72,040 | 🐛 365 | 🌐 C++ | 📅 2026-09-18 - List of add-ons for Protocol Buffers in main github repository
...
* [Wireshark Protobuf Dissector](https://github.com/128technology/protobuf_dissector) ⭐ 192 | 🐛 12 | 🌐 Lua | 📅 2019-01-19 - A Wireshark Lua plugin for decoding Google protobuf packets. [Relevant PR and discussion](https://github.com/google/protobuf/issues/3303) ⭐ 72,040 | 🐛 365 | 🌐 C++ | 📅 2026-09-18.
