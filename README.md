...
* [Technical documentation](https://github.com/grpc/grpc/tree/master/doc) ⭐ 45,281 | 🐛 1,348 | 🌐 C++ | 📅 2026-09-01 - Collection of useful technical documentation
* [gRPC status codes](https://github.com/grpc/grpc/blob/master/doc/statuscodes.md) ⭐ 45,281 | 🐛 1,348 | 🌐 C++ | 📅 2026-09-01 - Status codes and their use in gRPC
* [gRPC status code mapping](https://github.com/grpc/grpc/blob/master/doc/http-grpc-status-mapping.md) ⭐ 45,281 | 🐛 1,348 | 🌐 C++ | 📅 2026-09-01 - HTTP to gRPC Status Code Mapping
...
* [gRPC Core](https://github.com/grpc/grpc) ⭐ 45,281 | 🐛 1,348 | 🌐 C++ | 📅 2026-09-01 - C, C++, Ruby, Node.js, Python, PHP, C#, Objective-C
* [grpc\_cli](https://github.com/grpc/grpc/blob/master/doc/command_line_tool.md) ⭐ 45,281 | 🐛 1,348 | 🌐 C++ | 📅 2026-09-01 - gRPC CLI tool
* [gRPC Go](https://github.com/grpc/grpc-go) ⭐ 23,040 | 🐛 129 | 🌐 Go | 📅 2026-09-01 - The Go language implementation of gRPC. HTTP/2 based RPC
* [gRPC Java](https://github.com/grpc/grpc-java) ⭐ 12,063 | 🐛 529 | 🌐 Java | 📅 2026-09-01 - The Java gRPC implementation. HTTP/2 based RPC
...
* [gRPC C#](https://github.com/grpc/grpc-dotnet) ⭐ 4,485 | 🐛 176 | 🌐 C# | 📅 2026-08-17 - The C# language implementation of gRPC
* [gRPC Swift](https://github.com/grpc/grpc-swift) ⭐ 2,246 | 🐛 99 | 🌐 Swift | 📅 2026-08-10 - The Swift language implementation of gRPC
...
* [grpcurl](https://github.com/fullstorydev/grpcurl) ⭐ 12,797 | 🐛 122 | 🌐 Go | 📅 2026-08-31 - Like cURL, but for gRPC: Command-line tool for interacting with gRPC servers
...
* [grpc-client-cli](https://github.com/vadimi/grpc-client-cli) ⭐ 311 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - interactive gRPC client
...
* [grpcui](https://github.com/fullstorydev/grpcui) ⭐ 5,926 | 🐛 77 | 🌐 JavaScript | 📅 2026-08-31 - An interactive web UI for gRPC, along the lines of postman (also, a Go library for embedding these web UIs into Go HTTP servers)
...
* [Microcks](https://github.com/microcks/microcks) ⭐ 2,030 | 🐛 84 | 🌐 Java | 📅 2026-09-01 - A [Cloud Native Computing Sandbox project](https://landscape.cncf.io/?selected=microcks) 🚀 dedicated to API Mocking and Testing ([gRPC supported](https://microcks.io/documentation/using/grpc/))
...
* [karate-grpc](https://github.com/karatelabs/karate-examples/blob/main/grpc) ⭐ 38 | 🐛 0 | 🌐 Java | 📅 2026-04-11 - Example of using [Karate](https://github.com/karatelabs/karate) ⭐ 8,935 | 🐛 5 | 🌐 Java | 📅 2026-09-01 to integrate and test gRPC.
...
* [APISIX](https://github.com/apache/apisix) ⭐ 17,067 | 🐛 238 | 🌐 Lua | 📅 2026-09-01 - An api gateway that supports gRPC, HTTP(s) to gRPC and gRPC web request proxying.
* [ratelimit](https://github.com/lyft/ratelimit) ⭐ 2,688 | 🐛 38 | 🌐 Go | 📅 2026-08-31 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications
...
* [protoc-gen-gotemplate](https://github.com/moul/protoc-gen-gotemplate) ⭐ 441 | 🐛 26 | 🌐 Go | 📅 2026-09-01 - Generic generator based on golang's template system
...
* [grpcui](https://github.com/fullstorydev/grpcui) ⭐ 5,926 | 🐛 77 | 🌐 JavaScript | 📅 2026-08-31 - Embed a gRPC web UI into a Go gRPC/HTTP server
...
* [protoreflect](https://github.com/jhump/protoreflect) ⭐ 1,487 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - Reflection (Rich Descriptors) for Go Protocol Buffers
...
* [yarpc](https://github.com/yarpc/yarpc-go) ⭐ 440 | 🐛 57 | 🌐 Go | 📅 2026-08-31 - A message passing platform for Go, including support for gRPC
...
* [Armeria](https://github.com/line/armeria) ⭐ 5,134 | 🐛 703 | 🌐 Java | 📅 2026-09-01 - Asynchronous RPC/REST library built on top of Java 8, Netty, HTTP/2, Thrift and gRPC
...
* [gapic-generator-ruby](https://github.com/googleapis/gapic-generator-ruby) ⭐ 50 | 🐛 40 | 🌐 Ruby | 📅 2026-08-26 - Generates Ruby gRPC client libraries from protocol buffer definitions of an API.
...
* [tonic](https://github.com/hyperium/tonic) ⭐ 12,453 | 🐛 387 | 🌐 Rust | 📅 2026-08-28 - A native gRPC client & server implementation with async/await support
...
* [grpc-elixir](https://github.com/tony612/grpc-elixir) ⭐ 1,522 | 🐛 48 | 🌐 Elixir | 📅 2026-08-31 - The Elixir implementation of gRPC
...
* [asio-grpc](https://github.com/Tradias/asio-grpc) ⭐ 472 | 🐛 1 | 🌐 C++ | 📅 2026-03-31 - Asynchronous gRPC with [Boost.Asio](https://github.com/boostorg/asio) ⭐ 1,609 | 🐛 91 | 🌐 C++ | 📅 2026-08-12 or [libunifex](https://github.com/facebookexperimental/libunifex) ⭐ 1,715 | 🐛 104 | 🌐 C++ | 📅 2026-05-31
* [qtgrpc](https://github.com/qt/qtgrpc) ⭐ 26 | 🐛 0 | 🌐 C++ | 📅 2026-09-01 - gRPC and Protobuf generator and bindings for the Qt framework
...
* [Third-Party Add-ons for Protocol Buffers](https://github.com/protocolbuffers/protobuf/blob/master/docs/third_party.md) ⭐ 71,869 | 🐛 315 | 🌐 C++ | 📅 2026-09-01 - List of add-ons for Protocol Buffers in main github repository
...
* [api-linter](https://github.com/googleapis/api-linter) ⭐ 765 | 🐛 60 | 🌐 Go | 📅 2026-08-03 - A linter for APIs defined in protocol buffers.
...
* [Wireshark Protobuf Dissector](https://github.com/128technology/protobuf_dissector) ⭐ 192 | 🐛 12 | 🌐 Lua | 📅 2019-01-19 - A Wireshark Lua plugin for decoding Google protobuf packets. [Relevant PR and discussion](https://github.com/google/protobuf/issues/3303) ⭐ 71,869 | 🐛 315 | 🌐 C++ | 📅 2026-09-01.
