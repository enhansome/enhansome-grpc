...
* [Technical documentation](https://github.com/grpc/grpc/tree/master/doc) ⭐ 45,281 | 🐛 1,384 | 🌐 C++ | 📅 2026-08-13 - Collection of useful technical documentation
* [gRPC status codes](https://github.com/grpc/grpc/blob/master/doc/statuscodes.md) ⭐ 45,281 | 🐛 1,384 | 🌐 C++ | 📅 2026-08-13 - Status codes and their use in gRPC
* [gRPC status code mapping](https://github.com/grpc/grpc/blob/master/doc/http-grpc-status-mapping.md) ⭐ 45,281 | 🐛 1,384 | 🌐 C++ | 📅 2026-08-13 - HTTP to gRPC Status Code Mapping
...
* [gRPC Core](https://github.com/grpc/grpc) ⭐ 45,281 | 🐛 1,384 | 🌐 C++ | 📅 2026-08-13 - C, C++, Ruby, Node.js, Python, PHP, C#, Objective-C
* [grpc\_cli](https://github.com/grpc/grpc/blob/master/doc/command_line_tool.md) ⭐ 45,281 | 🐛 1,384 | 🌐 C++ | 📅 2026-08-13 - gRPC CLI tool
* [gRPC Go](https://github.com/grpc/grpc-go) ⭐ 23,038 | 🐛 127 | 🌐 Go | 📅 2026-08-13 - The Go language implementation of gRPC. HTTP/2 based RPC
* [gRPC Java](https://github.com/grpc/grpc-java) ⭐ 12,061 | 🐛 529 | 🌐 Java | 📅 2026-08-13 - The Java gRPC implementation. HTTP/2 based RPC
* [gRPC Web](https://github.com/grpc/grpc-web) ⭐ 9,251 | 🐛 170 | 🌐 JavaScript | 📅 2026-08-07 - gRPC for Web Clients
* [gRPC Node.js](https://github.com/grpc/grpc-node) ⭐ 4,844 | 🐛 237 | 🌐 TypeScript | 📅 2026-06-17 - gRPC for Node.js
* [gRPC C#](https://github.com/grpc/grpc-dotnet) ⭐ 4,479 | 🐛 180 | 🌐 C# | 📅 2026-08-11 - The C# language implementation of gRPC
...
* [gRPC Dart](https://github.com/grpc/grpc-dart) ⭐ 892 | 🐛 108 | 🌐 Dart | 📅 2026-08-03 - The Dart language implementation of gRPC
...
* [grpcurl](https://github.com/fullstorydev/grpcurl) ⭐ 12,778 | 🐛 120 | 🌐 Go | 📅 2026-07-27 - Like cURL, but for gRPC: Command-line tool for interacting with gRPC servers
...
* [grpc-client-cli](https://github.com/vadimi/grpc-client-cli) ⭐ 311 | 🐛 0 | 🌐 Go | 📅 2026-08-03 - interactive gRPC client
...
* [grpcui](https://github.com/fullstorydev/grpcui) ⭐ 5,917 | 🐛 78 | 🌐 JavaScript | 📅 2026-07-13 - An interactive web UI for gRPC, along the lines of postman (also, a Go library for embedding these web UIs into Go HTTP servers)
...
* [fortio](https://github.com/fortio/fortio) ⭐ 3,717 | 🐛 85 | 🌐 Go | 📅 2026-07-31 - A microservices (http, grpc) load testing library and tool from Istio project.
...
* [Microcks](https://github.com/microcks/microcks) ⭐ 2,013 | 🐛 90 | 🌐 Java | 📅 2026-08-12 - A [Cloud Native Computing Sandbox project](https://landscape.cncf.io/?selected=microcks) 🚀 dedicated to API Mocking and Testing ([gRPC supported](https://microcks.io/documentation/using/grpc/))
...
* [grpc\_bench](https://github.com/LesnyRumcajs/grpc_bench) ⭐ 935 | 🐛 33 | 🌐 Dockerfile | 📅 2026-06-22 - A suite of gRPC benchmarks for different technologies.
...
* [karate-grpc](https://github.com/karatelabs/karate-examples/blob/main/grpc) ⭐ 38 | 🐛 0 | 🌐 Java | 📅 2026-04-11 - Example of using [Karate](https://github.com/karatelabs/karate) ⭐ 8,921 | 🐛 16 | 🌐 Java | 📅 2026-08-13 to integrate and test gRPC.
...
* [APISIX](https://github.com/apache/apisix) ⭐ 16,986 | 🐛 253 | 🌐 Lua | 📅 2026-08-13 - An api gateway that supports gRPC, HTTP(s) to gRPC and gRPC web request proxying.
* [ratelimit](https://github.com/lyft/ratelimit) ⭐ 2,683 | 🐛 36 | 🌐 Go | 📅 2026-08-12 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,044 | 🐛 229 | 🌐 Java | 📅 2026-08-13 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [grpc-json-proxy](https://github.com/jnewmano/grpc-json-proxy) ⭐ 516 | 🐛 12 | 🌐 Go | 📅 2026-08-03 - A proxy which allows existing tools like Postman or curl to interact with gRPC servers
* [protoc-gen-gotemplate](https://github.com/moul/protoc-gen-gotemplate) ⭐ 441 | 🐛 26 | 🌐 Go | 📅 2026-08-13 - Generic generator based on golang's template system
...
* [limitador](https://github.com/Kuadrant/limitador) ⭐ 86 | 🐛 35 | 🌐 Rust | 📅 2026-08-07 - Generic rate-limiter written in Rust exposing a gRPC service that implements the Envoy Rate Limit protocol (v3).
...
* [go-kit gRPC](https://github.com/go-kit/kit/tree/master/transport/grpc) ⭐ 27,428 | 🐛 60 | 🌐 Go | 📅 2024-07-19 - [Go Kit](https://github.com/go-kit) with gRPC as transport
...
* [grpcui](https://github.com/fullstorydev/grpcui) ⭐ 5,917 | 🐛 78 | 🌐 JavaScript | 📅 2026-07-13 - Embed a gRPC web UI into a Go gRPC/HTTP server
...
* [ttrpc](https://github.com/containerd/ttrpc) ⭐ 657 | 🐛 30 | 🌐 Go | 📅 2026-07-25 - GRPC for low-memory environments
...
* [yarpc](https://github.com/yarpc/yarpc-go) ⭐ 440 | 🐛 62 | 🌐 Go | 📅 2026-08-12 - A message passing platform for Go, including support for gRPC
...
* [grpchan](https://github.com/fullstorydev/grpchan) ⭐ 229 | 🐛 3 | 🌐 Go | 📅 2026-08-07 - Channels for gRPC: custom transports, such as in-process and HTTP 1.1
...
* [protoc-gen-fieldmask](https://github.com/idodod/protoc-gen-fieldmask) ⭐ 30 | 🐛 13 | 🌐 Go | 📅 2026-08-13 - A protoc plugin that generates fieldmask paths as static type properties of proto messages
...
* [Armeria](https://github.com/line/armeria) ⭐ 5,130 | 🐛 702 | 🌐 Java | 📅 2026-08-11 - Asynchronous RPC/REST library built on top of Java 8, Netty, HTTP/2, Thrift and gRPC
...
* [django-grpc](https://github.com/gluk-w/django-grpc) ⭐ 244 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - Django application to build gRPC services with access to ORM, settings and everything else
...
* [tonic](https://github.com/hyperium/tonic) ⭐ 12,423 | 🐛 391 | 🌐 Rust | 📅 2026-08-11 - A native gRPC client & server implementation with async/await support
...
* [wtx](https://github.com/c410-f3r/wtx) ⭐ 394 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - RFC7541 and RFC9113 implementation with built-in support for `gRPC` connections.
...
* [grpc-elixir](https://github.com/tony612/grpc-elixir) ⭐ 1,519 | 🐛 39 | 🌐 Elixir | 📅 2026-07-27 - The Elixir implementation of gRPC
...
* [asio-grpc](https://github.com/Tradias/asio-grpc) ⭐ 471 | 🐛 1 | 🌐 C++ | 📅 2026-03-31 - Asynchronous gRPC with [Boost.Asio](https://github.com/boostorg/asio) ⭐ 1,598 | 🐛 90 | 🌐 C++ | 📅 2026-08-12 or [libunifex](https://github.com/facebookexperimental/libunifex) ⭐ 1,711 | 🐛 104 | 🌐 C++ | 📅 2026-05-31
* [qtgrpc](https://github.com/qt/qtgrpc) ⭐ 25 | 🐛 0 | 🌐 C++ | 📅 2026-08-12 - gRPC and Protobuf generator and bindings for the Qt framework
...
* [Hello gRPC](https://github.com/feuyeux/hello-grpc) ⭐ 19 | 🐛 20 | 🌐 Shell | 📅 2026-08-10 - Simple server and client examples showcasing gRPC features(including proxy and propagate, running in containers and kubernetes) with Java/Kotlin/Go/NodeJs/Python/Rust/C++/C#.
...
* [Third-Party Add-ons for Protocol Buffers](https://github.com/protocolbuffers/protobuf/blob/master/docs/third_party.md) ⭐ 71,727 | 🐛 300 | 🌐 C++ | 📅 2026-08-13 - List of add-ons for Protocol Buffers in main github repository

<a name="proto-package-managers"></a>

### Package Managers

* [buffrs](https://github.com/helsing-ai/buffrs) ⭐ 376 | 🐛 38 | 🌐 Rust | 📅 2026-06-27 – A modern package manager for protocol buffers and gRPC architectures.
...
* [Protovalidate](https://github.com/bufbuild/protovalidate) ⭐ 1,551 | 🐛 27 | 🌐 Go | 📅 2026-07-27 - Protovalidate provides standard annotations to validate common rules on messages and fields, as well as the ability to use CEL to write custom rules.
...
* [api-linter](https://github.com/googleapis/api-linter) ⭐ 763 | 🐛 60 | 🌐 Go | 📅 2026-08-03 - A linter for APIs defined in protocol buffers.
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 696 | 🐛 61 | 🌐 Go | 📅 2026-05-27 - A pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Wireshark Protobuf Dissector](https://github.com/128technology/protobuf_dissector) ⭐ 192 | 🐛 12 | 🌐 Lua | 📅 2019-01-19 - A Wireshark Lua plugin for decoding Google protobuf packets. [Relevant PR and discussion](https://github.com/google/protobuf/issues/3303) ⭐ 71,727 | 🐛 300 | 🌐 C++ | 📅 2026-08-13.
...
* [Twirp](https://github.com/twitchtv/twirp) ⭐ 7,527 | 🐛 14 | 🌐 Go | 📅 2024-08-05 - A simple RPC framework with protobuf service definitions
