...
* [Technical documentation](https://github.com/grpc/grpc/tree/master/doc) ⭐ 45,303 | 🐛 1,350 | 🌐 C++ | 📅 2026-09-09 - Collection of useful technical documentation
* [gRPC status codes](https://github.com/grpc/grpc/blob/master/doc/statuscodes.md) ⭐ 45,303 | 🐛 1,350 | 🌐 C++ | 📅 2026-09-09 - Status codes and their use in gRPC
* [gRPC status code mapping](https://github.com/grpc/grpc/blob/master/doc/http-grpc-status-mapping.md) ⭐ 45,303 | 🐛 1,350 | 🌐 C++ | 📅 2026-09-09 - HTTP to gRPC Status Code Mapping
...
* [gRPC Core](https://github.com/grpc/grpc) ⭐ 45,303 | 🐛 1,350 | 🌐 C++ | 📅 2026-09-09 - C, C++, Ruby, Node.js, Python, PHP, C#, Objective-C
* [grpc\_cli](https://github.com/grpc/grpc/blob/master/doc/command_line_tool.md) ⭐ 45,303 | 🐛 1,350 | 🌐 C++ | 📅 2026-09-09 - gRPC CLI tool
* [gRPC Go](https://github.com/grpc/grpc-go) ⭐ 23,052 | 🐛 136 | 🌐 Go | 📅 2026-09-09 - The Go language implementation of gRPC. HTTP/2 based RPC
* [gRPC Java](https://github.com/grpc/grpc-java) ⭐ 12,066 | 🐛 530 | 🌐 Java | 📅 2026-09-09 - The Java gRPC implementation. HTTP/2 based RPC
* [gRPC Web](https://github.com/grpc/grpc-web) ⭐ 9,257 | 🐛 169 | 🌐 JavaScript | 📅 2026-09-04 - gRPC for Web Clients
...
* [grpcurl](https://github.com/fullstorydev/grpcurl) ⭐ 12,804 | 🐛 119 | 🌐 Go | 📅 2026-09-02 - Like cURL, but for gRPC: Command-line tool for interacting with gRPC servers
...
* [Microcks](https://github.com/microcks/microcks) ⭐ 2,037 | 🐛 60 | 🌐 Java | 📅 2026-09-09 - A [Cloud Native Computing Sandbox project](https://landscape.cncf.io/?selected=microcks) 🚀 dedicated to API Mocking and Testing ([gRPC supported](https://microcks.io/documentation/using/grpc/))
...
* [karate-grpc](https://github.com/karatelabs/karate-examples/blob/main/grpc) ⭐ 38 | 🐛 0 | 🌐 Java | 📅 2026-04-11 - Example of using [Karate](https://github.com/karatelabs/karate) ⭐ 8,950 | 🐛 16 | 🌐 Java | 📅 2026-09-05 to integrate and test gRPC.
...
* [APISIX](https://github.com/apache/apisix) ⭐ 17,102 | 🐛 243 | 🌐 Lua | 📅 2026-09-09 - An api gateway that supports gRPC, HTTP(s) to gRPC and gRPC web request proxying.
...
* [protoc-gen-gotemplate](https://github.com/moul/protoc-gen-gotemplate) ⭐ 440 | 🐛 26 | 🌐 Go | 📅 2026-09-08 - Generic generator based on golang's template system
...
* [grpc-pentest-suite](https://github.com/nxenon/grpc-pentest-suite) ⭐ 262 | 🐛 0 | 🌐 Java | 📅 2026-09-08 - A collection of tools for pentesting gRPC-Web, including a Burp Suite extension for manipulating gRPC-Web payloads.
...
* [limitador](https://github.com/Kuadrant/limitador) ⭐ 89 | 🐛 38 | 🌐 Rust | 📅 2026-09-09 - Generic rate-limiter written in Rust exposing a gRPC service that implements the Envoy Rate Limit protocol (v3).
...
* [protoreflect](https://github.com/jhump/protoreflect) ⭐ 1,487 | 🐛 13 | 🌐 Go | 📅 2026-09-09 - Reflection (Rich Descriptors) for Go Protocol Buffers
...
* [yarpc](https://github.com/yarpc/yarpc-go) ⭐ 440 | 🐛 56 | 🌐 Go | 📅 2026-09-09 - A message passing platform for Go, including support for gRPC
...
* [Armeria](https://github.com/line/armeria) ⭐ 5,139 | 🐛 715 | 🌐 Java | 📅 2026-09-09 - Asynchronous RPC/REST library built on top of Java 8, Netty, HTTP/2, Thrift and gRPC
...
* [tonic](https://github.com/hyperium/tonic) ⭐ 12,461 | 🐛 388 | 🌐 Rust | 📅 2026-09-09 - A native gRPC client & server implementation with async/await support
...
* [grpc-elixir](https://github.com/tony612/grpc-elixir) ⭐ 1,522 | 🐛 45 | 🌐 Elixir | 📅 2026-09-08 - The Elixir implementation of gRPC
...
* [ts-proto](https://github.com/stephenh/ts-proto) ⭐ 2,592 | 🐛 172 | 🌐 TypeScript | 📅 2026-09-08 - Transforms your .proto files into strongly-typed, idiomatic TypeScript files!
...
* [qtgrpc](https://github.com/qt/qtgrpc) ⭐ 26 | 🐛 0 | 🌐 C++ | 📅 2026-09-09 - gRPC and Protobuf generator and bindings for the Qt framework
...
* [Ballerina gRPC](https://github.com/ballerina-platform/module-ballerina-grpc) ⭐ 123 | 🐛 3 | 🌐 Ballerina | 📅 2026-09-09 - Ballerina library for gRPC
...
* [Third-Party Add-ons for Protocol Buffers](https://github.com/protocolbuffers/protobuf/blob/master/docs/third_party.md) ⭐ 72,011 | 🐛 307 | 🌐 C++ | 📅 2026-09-09 - List of add-ons for Protocol Buffers in main github repository
...
* [Wireshark Protobuf Dissector](https://github.com/128technology/protobuf_dissector) ⭐ 192 | 🐛 12 | 🌐 Lua | 📅 2019-01-19 - A Wireshark Lua plugin for decoding Google protobuf packets. [Relevant PR and discussion](https://github.com/google/protobuf/issues/3303) ⭐ 72,011 | 🐛 307 | 🌐 C++ | 📅 2026-09-09.
