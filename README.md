...
* [Technical documentation](https://github.com/grpc/grpc/tree/master/doc) ⭐ 45,326 | 🐛 1,346 | 🌐 C++ | 📅 2026-09-18 - Collection of useful technical documentation
* [gRPC status codes](https://github.com/grpc/grpc/blob/master/doc/statuscodes.md) ⭐ 45,326 | 🐛 1,346 | 🌐 C++ | 📅 2026-09-18 - Status codes and their use in gRPC
* [gRPC status code mapping](https://github.com/grpc/grpc/blob/master/doc/http-grpc-status-mapping.md) ⭐ 45,326 | 🐛 1,346 | 🌐 C++ | 📅 2026-09-18 - HTTP to gRPC Status Code Mapping
...
* [gRPC Core](https://github.com/grpc/grpc) ⭐ 45,326 | 🐛 1,346 | 🌐 C++ | 📅 2026-09-18 - C, C++, Ruby, Node.js, Python, PHP, C#, Objective-C
* [grpc\_cli](https://github.com/grpc/grpc/blob/master/doc/command_line_tool.md) ⭐ 45,326 | 🐛 1,346 | 🌐 C++ | 📅 2026-09-18 - gRPC CLI tool
* [gRPC Go](https://github.com/grpc/grpc-go) ⭐ 23,070 | 🐛 140 | 🌐 Go | 📅 2026-09-17 - The Go language implementation of gRPC. HTTP/2 based RPC
* [gRPC Java](https://github.com/grpc/grpc-java) ⭐ 12,071 | 🐛 533 | 🌐 Java | 📅 2026-09-17 - The Java gRPC implementation. HTTP/2 based RPC
* [gRPC Web](https://github.com/grpc/grpc-web) ⭐ 9,260 | 🐛 170 | 🌐 JavaScript | 📅 2026-09-04 - gRPC for Web Clients
* [gRPC Node.js](https://github.com/grpc/grpc-node) ⭐ 4,842 | 🐛 237 | 🌐 TypeScript | 📅 2026-09-17 - gRPC for Node.js
* [gRPC C#](https://github.com/grpc/grpc-dotnet) ⭐ 4,482 | 🐛 176 | 🌐 C# | 📅 2026-09-17 - The C# language implementation of gRPC
...
* [gRPC Dart](https://github.com/grpc/grpc-dart) ⭐ 892 | 🐛 112 | 🌐 Dart | 📅 2026-09-18 - The Dart language implementation of gRPC
...
* [grpcurl](https://github.com/fullstorydev/grpcurl) ⭐ 12,818 | 🐛 118 | 🌐 Go | 📅 2026-09-02 - Like cURL, but for gRPC: Command-line tool for interacting with gRPC servers
* [Evans](https://github.com/ktr0731/evans) ⭐ 4,490 | 🐛 38 | 🌐 Go | 📅 2023-12-26 - more expressive universal gRPC (CLI) client
...
* [grpc-client-cli](https://github.com/vadimi/grpc-client-cli) ⭐ 311 | 🐛 0 | 🌐 Go | 📅 2026-09-17 - interactive gRPC client
...
* [grpcui](https://github.com/fullstorydev/grpcui) ⭐ 5,927 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-14 - An interactive web UI for gRPC, along the lines of postman (also, a Go library for embedding these web UIs into Go HTTP servers)
...
* [Milkman](https://github.com/warmuuh/milkman) ⭐ 1,338 | 🐛 13 | 🌐 Java | 📅 2026-09-17 - Extensible alternative to Postman for crafting all kinds of requests, not only for gRPC, also http, sql etc.
* [ezy](https://github.com/getezy/ezy) ⭐ 1,040 | 🐛 22 | 🌐 TypeScript | 📅 2024-05-26 - 🔥 Fully-featured GUI client for gRPC/gRPC-Web.
* [gRPCox](https://github.com/gusaul/grpcox) ⭐ 711 | 🐛 16 | 🌐 Go | 📅 2024-04-10 - Like Postman, but for gRPC. web based GUI Client for gRPC, extremely easy to use.
...
* [fortio](https://github.com/fortio/fortio) ⭐ 3,727 | 🐛 87 | 🌐 Go | 📅 2026-09-14 - A microservices (http, grpc) load testing library and tool from Istio project.
...
* [Microcks](https://github.com/microcks/microcks) ⭐ 2,044 | 🐛 55 | 🌐 Java | 📅 2026-09-18 - A [Cloud Native Computing Sandbox project](https://landscape.cncf.io/?selected=microcks) 🚀 dedicated to API Mocking and Testing ([gRPC supported](https://microcks.io/documentation/using/grpc/))
...
* [grpc-tools](https://github.com/bradleyjkemp/grpc-tools) ⭐ 1,240 | 🐛 39 | 🌐 Go | 📅 2023-11-14 - A suite of gRPC debugging tools. Like Fiddler/Charles but for gRPC.
...
* [karate-grpc](https://github.com/karatelabs/karate-examples/blob/main/grpc) ⭐ 40 | 🐛 0 | 🌐 Java | 📅 2026-04-11 - Example of using [Karate](https://github.com/karatelabs/karate) ⭐ 8,958 | 🐛 15 | 🌐 Java | 📅 2026-09-19 to integrate and test gRPC.
...
* [APISIX](https://github.com/apache/apisix) ⭐ 17,146 | 🐛 238 | 🌐 Lua | 📅 2026-09-18 - An api gateway that supports gRPC, HTTP(s) to gRPC and gRPC web request proxying.
* [ratelimit](https://github.com/lyft/ratelimit) ⭐ 2,697 | 🐛 42 | 🌐 Go | 📅 2026-09-18 - Go/gRPC service designed to enable generic rate limit scenarios from different types of applications
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,722 | 🐛 275 | 🌐 Java | 📅 2026-09-19 - An API gateway built for event-driven architectures and streaming that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [grpc-json-proxy](https://github.com/jnewmano/grpc-json-proxy) ⭐ 515 | 🐛 12 | 🌐 Go | 📅 2026-09-14 - A proxy which allows existing tools like Postman or curl to interact with gRPC servers
* [protoc-gen-gotemplate](https://github.com/moul/protoc-gen-gotemplate) ⭐ 442 | 🐛 26 | 🌐 Go | 📅 2026-09-18 - Generic generator based on golang's template system
...
* [limitador](https://github.com/Kuadrant/limitador) ⭐ 89 | 🐛 42 | 🌐 Rust | 📅 2026-09-16 - Generic rate-limiter written in Rust exposing a gRPC service that implements the Envoy Rate Limit protocol (v3).
...
* [rpcx](https://github.com/smallnest/rpcx) ⭐ 8,315 | 🐛 4 | 🌐 Go | 📅 2026-09-03 - A RPC service framework based on net/rpc like alibaba Dubbo and weibo Motan
* [grpcui](https://github.com/fullstorydev/grpcui) ⭐ 5,927 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-14 - Embed a gRPC web UI into a Go gRPC/HTTP server
...
* [protoreflect](https://github.com/jhump/protoreflect) ⭐ 1,488 | 🐛 12 | 🌐 Go | 📅 2026-09-09 - Reflection (Rich Descriptors) for Go Protocol Buffers
...
* [ttrpc](https://github.com/containerd/ttrpc) ⭐ 663 | 🐛 31 | 🌐 Go | 📅 2026-09-02 - GRPC for low-memory environments
...
* [yarpc](https://github.com/yarpc/yarpc-go) ⭐ 442 | 🐛 63 | 🌐 Go | 📅 2026-09-18 - A message passing platform for Go, including support for gRPC
* [grpc-web-devtools](https://github.com/SafetyCulture/grpc-web-devtools) ⭐ 440 | 🐛 58 | 🌐 JavaScript | 📅 2025-07-25 - Chrome Browser extension to aid gRPC-Web development
...
* [protoc-gen-fieldmask](https://github.com/idodod/protoc-gen-fieldmask) ⭐ 30 | 🐛 13 | 🌐 Go | 📅 2026-09-18 - A protoc plugin that generates fieldmask paths as static type properties of proto messages
...
* [Armeria](https://github.com/line/armeria) ⭐ 5,144 | 🐛 710 | 🌐 Java | 📅 2026-09-17 - Asynchronous RPC/REST library built on top of Java 8, Netty, HTTP/2, Thrift and gRPC
...
* [gapic-generator-ruby](https://github.com/googleapis/gapic-generator-ruby) ⭐ 50 | 🐛 39 | 🌐 Ruby | 📅 2026-09-18 - Generates Ruby gRPC client libraries from protocol buffer definitions of an API.
...
* [tonic](https://github.com/hyperium/tonic) ⭐ 12,477 | 🐛 362 | 🌐 Rust | 📅 2026-09-18 - A native gRPC client & server implementation with async/await support
...
* [wtx](https://github.com/c410-f3r/wtx) ⭐ 401 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 - RFC7541 and RFC9113 implementation with built-in support for `gRPC` connections.
...
* [grpc-elixir](https://github.com/tony612/grpc-elixir) ⭐ 1,524 | 🐛 52 | 🌐 Elixir | 📅 2026-09-08 - The Elixir implementation of gRPC
...
* [nice-grpc](https://github.com/deeplay-io/nice-grpc) ⭐ 540 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-10 - gRPC library for Node.js and the Browser with modern API and middleware support.
...
* [fs2-grpc](https://github.com/typelevel/fs2-grpc) ⭐ 284 | 🐛 15 | 🌐 Scala | 📅 2026-09-19 - gRPC implementation for FS2/cats-effect using netty
...
* [http4s-grpc](https://github.com/http4s/http4s-grpc) ⭐ 49 | 🐛 5 | 🌐 Scala | 📅 2026-09-19 - A pure Scala gRPC implementation! Use it with http4s Ember and deploy on JVM, Node.js, and Native.
...
* [sisyphus](https://github.com/ButterCam/sisyphus) ⭐ 100 | 🐛 9 | 🌐 Kotlin | 📅 2024-04-08 - Modern gRPC back-end development framework based on Kotlin/Spring Boot with Message DSL/[HTTP transcoding](https://aip.bybutter.com/127)/[Google AIP](https://aip.bybutter.com) support.
...
* [asio-grpc](https://github.com/Tradias/asio-grpc) ⭐ 472 | 🐛 1 | 🌐 C++ | 📅 2026-03-31 - Asynchronous gRPC with [Boost.Asio](https://github.com/boostorg/asio) ⭐ 1,618 | 🐛 91 | 🌐 C++ | 📅 2026-08-12 or [libunifex](https://github.com/facebookexperimental/libunifex) ⭐ 1,716 | 🐛 104 | 🌐 C++ | 📅 2026-05-31
* [qtgrpc](https://github.com/qt/qtgrpc) ⭐ 26 | 🐛 0 | 🌐 C++ | 📅 2026-09-17 - gRPC and Protobuf generator and bindings for the Qt framework
...
* [Ballerina gRPC](https://github.com/ballerina-platform/module-ballerina-grpc) ⭐ 122 | 🐛 0 | 🌐 Ballerina | 📅 2026-09-18 - Ballerina library for gRPC
...
* [Streaming RPC's using gRPC](https://github.com/ridha/grpc-streaming-demo) ⭐ 164 | 🐛 0 | 🌐 Go | 📅 2017-03-11 - A quick demo of bi-directional streaming RPC's using grpc, Go and Python
...
* [Hello gRPC](https://github.com/feuyeux/hello-grpc) ⭐ 19 | 🐛 16 | 🌐 Shell | 📅 2026-09-14 - Simple server and client examples showcasing gRPC features(including proxy and propagate, running in containers and kubernetes) with Java/Kotlin/Go/NodeJs/Python/Rust/C++/C#.
...
* [Third-Party Add-ons for Protocol Buffers](https://github.com/protocolbuffers/protobuf/blob/master/docs/third_party.md) ⭐ 72,045 | 🐛 380 | 🌐 C++ | 📅 2026-09-19 - List of add-ons for Protocol Buffers in main github repository
...
* [buffrs](https://github.com/helsing-ai/buffrs) ⭐ 384 | 🐛 43 | 🌐 Rust | 📅 2026-06-27 – A modern package manager for protocol buffers and gRPC architectures.

<a name="proto-tools"></a>

### Tools

* [protoc-gen-doc](https://github.com/pseudomuto/protoc-gen-doc) ⭐ 2,841 | 🐛 130 | 🌐 Go | 📅 2026-07-21 - Documentation generator plugin for Google Protocol Buffers
* [Protovalidate](https://github.com/bufbuild/protovalidate) ⭐ 1,566 | 🐛 30 | 🌐 Go | 📅 2026-09-10 - Protovalidate provides standard annotations to validate common rules on messages and fields, as well as the ability to use CEL to write custom rules.
...
* [api-linter](https://github.com/googleapis/api-linter) ⭐ 765 | 🐛 59 | 🌐 Go | 📅 2026-09-10 - A linter for APIs defined in protocol buffers.
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 699 | 🐛 59 | 🌐 Go | 📅 2026-09-18 - A pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Wireshark Protobuf Dissector](https://github.com/128technology/protobuf_dissector) ⭐ 192 | 🐛 12 | 🌐 Lua | 📅 2019-01-19 - A Wireshark Lua plugin for decoding Google protobuf packets. [Relevant PR and discussion](https://github.com/google/protobuf/issues/3303) ⭐ 72,045 | 🐛 380 | 🌐 C++ | 📅 2026-09-19.
...
* [reactive-grpc](https://github.com/salesforce/reactive-grpc) ⭐ 838 | 🐛 32 | 🌐 Java | 📅 2026-06-02 - Integrates reactive programming with grpc-java
